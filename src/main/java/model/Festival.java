...
/**
 * Immutable record representing a music festival with a name and a performance schedule. The
 * schedule maps each {@link Performance} to the {@link Stage} it is assigned to.
 *
